...
#Power bars to determine strength
...
while run:
  ...
  for i, ball in enumerate(balls):
    for pocket in pockets:
      ...
      if ball_dist <= pocket_dia / 2:
        ...
        #Check if the potted ball is the cue ball
        if i == len(balls) - 1:
          lives -= 1
  ...
  draw_text("LIVES REMAINING: " + str(lives), font, WHITE, SCREEN_WIDTH - 700, SCREEN_HEIGHT + 10)
